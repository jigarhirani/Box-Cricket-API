...
namespace APIBOXCricket.DAL
{
    ...
    {
        #region Method: MST_Ground_SelectAll_ByBoxCricketID
        public List<MST_GroundModel> MST_Ground_SelectAll_ByBoxCricketID(int BOXCricketID)
        {
            try
            {
                ...
                DbCommand cmd = sqlDb.GetStoredProcCommand("PR_MST_Ground_SelectAll_ByBoxCricketID");
                sqlDb.AddInParameter(cmd, "@BOXCricketID", SqlDbType.Int, BOXCricketID);
